...
namespace DatingApp.API.Controllers
{
    ...
    public class MessagesController : ControllerBase
    {
        ...
        {
            // verifica se o id passado corresponde com o id do usuário logado
        ...
        public async Task<IActionResult> GetMessagesForUser(int userId, [FromQuery]MessageParams messageParams){
            ...
            // envia para o header do response as informações necessárias para o SPA tratar
        ...
        public async Task<IActionResult> DeleteMessage(int userId, int messageId){
            ...
            var messagemFromRepo = await _repo.GetMessage(messageId);

            if(messagemFromRepo.SenderId == userId)
                messagemFromRepo.SenderDeleted = true;

            if(messagemFromRepo.RecipientId == userId)
                messagemFromRepo.RecipientDeleted = true;
            
            if(messagemFromRepo.SenderDeleted && messagemFromRepo.RecipientDeleted) {
                _repo.Delete(messagemFromRepo);
            }
